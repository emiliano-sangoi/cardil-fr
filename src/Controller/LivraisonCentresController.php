...
class LivraisonCentresController extends AbstractController
{
    ...
    public function index(Fournisseur $fournisseur, LivraisonCentreRepository $livraisonCentreRepository): Response
    {
    ...
    public function new(Request $request, LivraisonCentreRepository $livraisonCentreRepository): Response
    {
    ...
    public function show(LivraisonCentre $livraisonCentre): Response
    {
    ...
    public function edit(Request $request, LivraisonCentre $livraisonCentre, LivraisonCentreRepository $livraisonCentreRepository): Response
    {
        $form = $this->createForm(LivraisonCentreType::class, $livraisonCentre);
        $form->handleRequest($request);
